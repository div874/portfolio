    ...
    >
      ...
      <div className="editorial-paper">
        ...
        <div className="editorial-content">
          <Link to="/journey" className="editorial-back-btn">&larr; BACK TO JOURNAL</Link>
            ...
            <section className="related-entries">
              ...
              <ul className="related-list">
                {relatedEntries.map(related => (
                  <li key={related.id}>
                    <Link to={`/journey/${related.slug}`}>&rarr; {related.title}</Link>
                  </li>
                ))}
              </ul>
            </section>
          ...
          <div className="article-share">
            ...
            <span>&middot;</span>
            <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(window.location.href)}`} target="_blank" rel="noreferrer" className="share-btn">
              LinkedIn
            </a>
          </div>
