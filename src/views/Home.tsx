...
const clientLogos = [
  { name: '1page.info', logo: '/logos/1page.info.webp' },
  { name: 'MTP', logo: '/logos/MTP.webp' },
  { name: 'Skillssoft', logo: '/logos/SKillssoft.webp' },
  { name: 'Siddhgiri', logo: '/logos/Siddhgiri.webp' },
  { name: 'VHS ENG', logo: '/logos/VHS ENG.webp' },
  { name: 'Brandloom', logo: '/logos/brandloom.webp' },
  { name: 'Elite Organic', logo: '/logos/elite_organic.webp' },
  { name: 'Soulcare', logo: '/logos/soulcare.webp' },
  { name: 'Virtual Systems', logo: '/logos/virtual_systems .webp' },
];
    ...
    <div className="page-home">
      ...
      <section className="section" style={{ paddingTop: '40px', paddingBottom: '60px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '40px', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <Link href="/projects" className="glow-button" style={{ textDecoration: 'none', padding: '10px 20px', fontSize: '0.9rem' }}>
            Browse All Projects →
          </Link>
        </div>
